...
describe "BlackHoleTaskRequest" do
  describe "#create" do
    it "should not make an HTTP request" do
      task_request = SharedWorkforce::BlackHoleTaskRequest.new(SharedWorkforce::Task.find("Approve photo"), :callback_params=>{:resource_id=>'1234'})
      task_request.create
